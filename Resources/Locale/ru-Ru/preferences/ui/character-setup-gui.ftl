...
character-setup-gui-create-new-character-button = Создать нового персонааж
character-setup-gui-create-new-character-button-tooltip = Максимсальное количество персонажей - {$maxCharacters}.
