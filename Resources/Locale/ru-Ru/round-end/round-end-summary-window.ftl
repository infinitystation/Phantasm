round-end-summary-window-title = Итог раунда
round-end-summary-window-round-end-summary-tab-title = Информация
round-end-summary-window-player-manifesto-tab-title = Манифест
round-end-summary-window-round-id-label = Рунда [color=white]#{ $roundId }[/color] закончен.
round-end-summary-window-gamemode-name-label = Игровым режимом был... [color=white]{ $gamemode }[/color]!
