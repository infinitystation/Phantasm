...
random-sentience-event-data-2 = наши модели вероятности
random-sentience-event-data-3 = наши показания
random-sentience-event-data-4 = коммуникационный трафик
random-sentience-event-data-5 = обнаруженные энергетические всплески
...
random-sentience-event-strength-2 = примата
random-sentience-event-strength-3 = среднего
random-sentience-event-strength-4 = охраны
...
station-event-random-sentience-announcement = Опираясь на { $data }, стало известно, что { $amount ->
    [1] { $kind1 }
    [2] { $kind1 } и { $kind2 }
    [3] { $kind1 }, { $kind2 }, и { $kind3 }
    *[other] { $kind1 }, { $kind2 }, { $kind3 }, и т.д.
} обрели интеллект уровня { $strength } со способность к общению.

## Ghost role description

station-event-random-sentience-role-description = Ты разумный { $name }, оживший по непонятным обстоятельствам.
