...
holiday-greet = Поздравляем с {$holidayName}!

## Holiday Names

holiday-name-new-year = Новым Годом
holiday-name-mister-lizard = Mister Lizard's Birthday
holiday-name-chinese-new-year = Китайским Новым Годом!
holiday-name-groundhog-day = Groundhog Day
holiday-name-travis-scott-day = Travis Scott Day
holiday-name-valentines-day = Днем Святого Валентина
holiday-name-birthday13 = Днем рождения Space Station 13
...
holiday-name-birthday14 = днем рождения Space Station 14
holiday-name-labor-day = Labor Day
holiday-name-firefighter-day = Firefighter's Day
holiday-name-mothers-day = днем Матери
...
holiday-name-beer-day = Днем Пива
...
holiday-name-halloween = Хэллоуином
...
holiday-name-friday-thirteenth = 13-ой пятницей
