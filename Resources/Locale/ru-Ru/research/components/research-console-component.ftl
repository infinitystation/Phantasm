...
research-console-menu-unlocked-technologies-label = Изученные технологнии
...
research-console-menu-server-sync-button = Синхронизироваться
research-console-menu-server-unlock-button = Разблокировать
