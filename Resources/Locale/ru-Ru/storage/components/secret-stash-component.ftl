...
comp-secret-stash-action-hide-success = Ты спрятал { $item } в { $this }
comp-secret-stash-action-hide-container-not-empty = Здесь уже что-то есть?
comp-secret-stash-action-hide-item-too-big = { $item } слишком большой, чтобы спрятать его в {$stash}!
